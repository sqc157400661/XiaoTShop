### 通知：十分抱歉，因为最近工作任务紧张+高级搜索项目转go 学习任务也挺大,计划更新时间会延期段时间，预计19年3月25开始再次迭代这个开源项目。
...
+ 2019.4.20  发布体验版  版本 v0.6.2  【* 订单促销优惠】
+ 2019.4.30  发布体验版  版本 v0.8.1  【系统安装和升级控制优化】
+ 2019.5.20  发布体验版  版本 v0.9.6  【添加单元测试规范】
+ 2019.5.28  发布体验版  版本 v1.1.0  【添加团购和砍价功能 开启商业使用版本】
